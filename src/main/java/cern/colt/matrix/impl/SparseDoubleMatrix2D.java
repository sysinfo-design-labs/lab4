...
Uses a {@link OpenIntDoubleHashMap}, which is a compact and performant hashing technique.
<p>
 ...
 * All entries are initially <tt>0</tt>.
 * For details related to memory usage see {@link OpenIntDoubleHashMap}.
 * 
 * @param rows the number of rows the matrix shall have.
 * @param columns the number of columns the matrix shall have.
